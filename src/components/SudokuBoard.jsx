...
const SudokuBoard = ({
    ...
    return (
        <div className={`glass-effect rounded-2xl p-6 shadow-2xl relative ${darkMode ? 'bg-gray-800/30' : ''}`}>
            {isPaused && (
                ...
                {board.map((row, rowIndex) =>
                    row.map((cell, colIndex) => (
                        <SudokuCell
                            ...
                            isSameNumber={highlightSameNumbers && getIsSameNumber(rowIndex, colIndex)}
